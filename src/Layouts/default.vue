...
<template>
  <div class="pages">
    <header>
      ...
      <span :class="{ 'mobile-dropDown-btn': isDropDown }" class="min-[960px]:hidden cursor-pointer" @click="dropDownToggle">
